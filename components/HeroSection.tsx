...
export default function HeroSection() {
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-xs sm:max-w-lg md:max-w-2xl mx-auto">
        <p className="font-sans text-xs uppercase tracking-[0.3em] text-blue-sky mb-6">
          Minister of the Gospel | UK &amp; Nigeria
        </p>
        <h1 className="font-serif text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-white leading-[0.95] mb-8">
          {MINISTER_NAME}
        </h1>
        <p className="font-sans text-sm sm:text-base text-white/70 max-w-xl mx-auto mb-8 sm:mb-12 leading-relaxed">
          {TAGLINE}
        </p>
