  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        <h1 className="font-serif text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-white leading-[0.95] mb-8">
          {MINISTER_NAME}
        </h1>
        <p className="font-sans text-base sm:text-lg text-white/70 max-w-xl mx-auto mb-8 sm:mb-12 leading-relaxed">
          {TAGLINE}
        </p>
